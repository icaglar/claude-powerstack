...
1. Ruflo CLI'yı hazır hale getirir (`npx @claude-flow/cli@3.38.21latest`)
...
```bash
# 1. Ruflo
claude mcp add claude-flow -- npx -y @claude-flow/cli@3.38.21latest
...
> Kısa alias: `ruflo` (yoksa `npx @claude-flow/cli@3.38.21latest`)
