...
1. Ruflo CLI'yı hazır hale getirir (`npx @claude-flow/cli@3.7.0-alpha.68latest`)
...
```bash
# 1. Ruflo
claude mcp add claude-flow -- npx -y @claude-flow/cli@3.7.0-alpha.68latest
...
> Kısa alias: `ruflo` (yoksa `npx @claude-flow/cli@3.7.0-alpha.68latest`)
